...
class MyimagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create myimage" do
    assert_difference('Myimage.count') do
      post myimages_url, params: { myimage: { description: @myimage.description, img: @myimage.img, product_id: @myimage.product_id, title: @myimage.title } }
    end
  ...
  test "should update myimage" do
    patch myimage_url(@myimage), params: { myimage: { description: @myimage.description, img: @myimage.img, product_id: @myimage.product_id, title: @myimage.title } }
